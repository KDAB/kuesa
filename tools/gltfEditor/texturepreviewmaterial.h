...
#ifndef TEXTUREPREVIEWMATERIAL_H
#define TEXTUREPREVIEWMATERIAL_H

#include <Qt3DRender/QMaterial>

class TexturePreviewMaterial : public Qt3DRender::QMaterial
{
    Q_OBJECT
    Q_PROPERTY(Qt3DRender::QAbstractTexture *texture READ texture WRITE setTexture NOTIFY textureChanged)
public:
    explicit TexturePreviewMaterial(Qt3DCore::QNode *parent = nullptr);
...
#endif // TEXTUREPREVIEWMATERIAL_H
