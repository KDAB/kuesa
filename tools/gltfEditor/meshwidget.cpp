...
void MeshWidget::setMeshInspector(MeshInspector *inspector)
{
    ...
    connect(m_ui->generateNormalsButton, &QPushButton::clicked, m_inspector, &MeshInspector::generateNormals);
...
void MeshWidget::updateData()
{
    ...
    m_ui->normalsGroupBox->setVisible(m_inspector->needsNormals());
}
