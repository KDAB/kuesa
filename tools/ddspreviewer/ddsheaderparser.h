...
#ifndef DDSHEADERPARSER_H
#define DDSHEADERPARSER_H

#include <QObject>
#include <QUrl>

class DDSHeaderParser : public QObject
{
    Q_OBJECT
    Q_PROPERTY(QUrl filePath READ filePath WRITE setFilePath NOTIFY filePathChanged)
    Q_PROPERTY(QString ddsHeader READ ddsHeader NOTIFY ddsHeaderChanged)
public:
    enum DdsFlags {
    ...
    explicit DDSHeaderParser(QObject *parent = nullptr);
    ~DDSHeaderParser();

    QUrl filePath() const;
    QString ddsHeader() const;
