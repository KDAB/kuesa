...
class Window(Qt3DExtras.Qt3DWindow):
    ...
    def changeTonemapping(self):
        # Note : the "None" enum value used in C++ is not useable in Python since None is a keyword.
        if(self.toneMapAlgorithm == Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping()):
            self.toneMapAlgorithm = Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Reinhard
        elif(self.toneMapAlgorithm == Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Reinhard):
            self.toneMapAlgorithm = Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Uncharted
        elif(self.toneMapAlgorithm == Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Uncharted):
            self.toneMapAlgorithm = Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Filmic
        elif(self.toneMapAlgorithm == Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping.Filmic):
            self.toneMapAlgorithm = Kuesa.ToneMappingAndGammaCorrectionEffect.ToneMapping()
