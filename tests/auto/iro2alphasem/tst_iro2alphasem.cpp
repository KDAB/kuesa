...
#include <Kuesa/iro2alphasemeffect.h>
#include <Kuesa/private/iro2alphasemtechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2AlphaSemEffect;
using TestedTechnique = Iro2AlphaSemTechnique;

class Iro2AlphaSemTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2AlphaSemTest)

#include "tst_iro2alphasem.moc"
