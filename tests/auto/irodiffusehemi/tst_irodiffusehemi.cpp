...
#include <Kuesa/irodiffusehemieffect.h>
#include <Kuesa/private/irodiffusehemitechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroDiffuseHemiEffect;
using TestedTechnique = IroDiffuseHemiTechnique;

class IroDiffuseHemiTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroDiffuseHemiTest)

#include "tst_irodiffusehemi.moc"
