...
#include <Kuesa/iro2alphaequirecteffect.h>
#include <Kuesa/private/iro2alphaequirecttechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2AlphaEquiRectEffect;
using TestedTechnique = Iro2AlphaEquiRectTechnique;

class Iro2AlphaEquiRectTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2AlphaEquiRectTest)

#include "tst_iro2alphaequirect.moc"
