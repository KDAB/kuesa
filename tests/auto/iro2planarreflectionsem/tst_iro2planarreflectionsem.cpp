/*
    tst_iro2planarreflectionsem.cpp
...
#include <Kuesa/iro2planarreflectionsemeffect.h>
#include <Kuesa/private/iro2planarreflectionsemtechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2PlanarReflectionSemEffect;
using TestedTechnique = Iro2PlanarReflectionSemTechnique;

class Iro2PlanarReflectionSemTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2PlanarReflectionSemTest)

#include "tst_iro2planarreflectionsem.moc"
