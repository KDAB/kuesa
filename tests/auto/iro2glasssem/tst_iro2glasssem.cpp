...
#include <Kuesa/iro2glasssemeffect.h>
#include <Kuesa/private/iro2glasssemtechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2GlassSemEffect;
using TestedTechnique = Iro2GlassSemTechnique;

class Iro2GlassSemTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2GlassSemTest)

#include "tst_iro2glasssem.moc"
