...
#include <Kuesa/iro2diffuseequirecteffect.h>
#include <Kuesa/private/iro2diffuseequirecttechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2DiffuseEquiRectEffect;
using TestedTechnique = Iro2DiffuseEquiRectTechnique;

class Iro2DiffuseEquiRectTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2DiffuseEquiRectTest)

#include "tst_iro2diffuseequirect.moc"
