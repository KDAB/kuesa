...
class tst_MeshCollection : public QObject
{
    Q_OBJECT
...
private Q_SLOTS:
    ...
    {
        // GIVEN
        Kuesa::MeshCollection collection;
...
QTEST_GUILESS_MAIN(tst_MeshCollection)
#include "tst_meshcollection.moc"
