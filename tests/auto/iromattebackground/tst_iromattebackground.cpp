...
#include <Kuesa/iromattebackgroundeffect.h>
#include <Kuesa/private/iromattebackgroundtechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteBackgroundEffect;
using TestedTechnique = IroMatteBackgroundTechnique;

class IroMatteBackgroundTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteBackgroundTest)

#include "tst_iromattebackground.moc"
