/*
    tst_iro2planarreflectionequirect.cpp
...
#include <Kuesa/iro2planarreflectionequirecteffect.h>
#include <Kuesa/private/iro2planarreflectionequirecttechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2PlanarReflectionEquiRectEffect;
using TestedTechnique = Iro2PlanarReflectionEquiRectTechnique;

class Iro2PlanarReflectionEquiRectTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2PlanarReflectionEquiRectTest)

#include "tst_iro2planarreflectionequirect.moc"
