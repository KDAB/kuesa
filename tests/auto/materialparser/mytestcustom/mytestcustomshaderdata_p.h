...
#ifndef KUESA_MYTESTCUSTOMSHADERDATA_P_H
#define KUESA_MYTESTCUSTOMSHADERDATA_P_H
...
public:
    explicit MyTestCustomShaderData(Qt3DCore::QNode *parent = nullptr);
    ~MyTestCustomShaderData();
...
private:
    QVector4D m_customVec4Parameter;
...
#endif // KUESA_MYTESTCUSTOMSHADERDATA_P_H
