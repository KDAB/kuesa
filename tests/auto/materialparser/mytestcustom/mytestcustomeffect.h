...
#ifndef KUESA_MYTESTCUSTOMEFFECT_H
#define KUESA_MYTESTCUSTOMEFFECT_H
...
public:
    Q_INVOKABLE explicit MyTestCustomEffect(Qt3DCore::QNode *parent = nullptr);
    ~MyTestCustomEffect();
...
private:
    ...
    MyTestCustomTechnique *m_gl3Technique;
    MyTestCustomTechnique *m_es3Technique;
    MyTestCustomTechnique *m_es2Technique;
};
...
#endif // KUESA_MYTESTCUSTOMEFFECT_H
