...
#include <Kuesa/iro2diffusesemeffect.h>
#include <Kuesa/private/iro2diffusesemtechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2DiffuseSemEffect;
using TestedTechnique = Iro2DiffuseSemTechnique;

class Iro2DiffuseSemTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2DiffuseSemTest)

#include "tst_iro2diffusesem.moc"
