...
#include <Kuesa/iromattemulteffect.h>
#include <Kuesa/private/iromattemulttechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteMultEffect;
using TestedTechnique = IroMatteMultTechnique;

class IroMatteMultTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteMultTest)

#include "tst_iromattemult.moc"
