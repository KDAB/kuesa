...
#include <Kuesa/iro2glassequirecteffect.h>
#include <Kuesa/private/iro2glassequirecttechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2GlassEquiRectEffect;
using TestedTechnique = Iro2GlassEquiRectTechnique;

class Iro2GlassEquiRectTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2GlassEquiRectTest)

#include "tst_iro2glassequirect.moc"
