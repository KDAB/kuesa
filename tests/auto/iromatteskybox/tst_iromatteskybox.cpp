...
#include <Kuesa/iromatteskyboxeffect.h>
#include <Kuesa/private/iromatteskyboxtechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteSkyboxEffect;
using TestedTechnique = IroMatteSkyboxTechnique;

class IroMatteSkyboxTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteSkyboxTest)

#include "tst_iromatteskybox.moc"
