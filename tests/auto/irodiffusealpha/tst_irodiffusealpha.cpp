...
#include <Kuesa/irodiffusealphaeffect.h>
#include <Kuesa/private/irodiffusealphatechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroDiffuseAlphaEffect;
using TestedTechnique = IroDiffuseAlphaTechnique;

class IroDiffuseAlphaTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroDiffuseAlphaTest)

#include "tst_irodiffusealpha.moc"
