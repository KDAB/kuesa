...
#include <Kuesa/iro2mattealphaeffect.h>
#include <Kuesa/private/iro2mattealphatechnique_p.h>

using namespace Kuesa;
using TestedEffect = Iro2MatteAlphaEffect;
using TestedTechnique = Iro2MatteAlphaTechnique;

class Iro2MatteAlphaTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(Iro2MatteAlphaTest)

#include "tst_iro2mattealpha.moc"
