...
#include <Kuesa/iromatteaddeffect.h>
#include <Kuesa/private/iromatteaddtechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteAddEffect;
using TestedTechnique = IroMatteAddTechnique;

class IroMatteAddTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteAddTest)

#include "tst_iromatteadd.moc"
