...
#include <Kuesa/private/irodiffusetechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroDiffuseEffect;
using TestedTechnique = IroDiffuseTechnique;

class IroDiffuseTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroDiffuseTest)

#include "tst_irodiffuse.moc"
