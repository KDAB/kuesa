...
#include <Kuesa/iroglassaddeffect.h>
#include <Kuesa/private/iroglassaddtechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroGlassAddEffect;
using TestedTechnique = IroGlassAddTechnique;

class IroGlassAddTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroGlassAddTest)

#include "tst_iroglassadd.moc"
