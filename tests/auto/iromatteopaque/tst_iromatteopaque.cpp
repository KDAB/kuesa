...
#include <Kuesa/iromatteopaqueeffect.h>
#include <Kuesa/private/iromatteopaquetechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteOpaqueEffect;
using TestedTechnique = IroMatteOpaqueTechnique;

class IroMatteOpaqueTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteOpaqueTest)

#include "tst_iromatteopaque.moc"
