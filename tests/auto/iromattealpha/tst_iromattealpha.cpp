...
#include <Kuesa/iromattealphaeffect.h>
#include <Kuesa/private/iromattealphatechnique_p.h>

using namespace Kuesa;
using TestedEffect = IroMatteAlphaEffect;
using TestedTechnique = IroMatteAlphaTechnique;

class IroMatteAlphaTest : public QObject
{
    Q_OBJECT
...
QTEST_MAIN(IroMatteAlphaTest)

#include "tst_iromattealpha.moc"
