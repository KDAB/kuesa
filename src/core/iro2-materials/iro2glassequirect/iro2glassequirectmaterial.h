...
#ifndef KUESA_IRO2GLASSEQUIRECTMATERIAL_H
#define KUESA_IRO2GLASSEQUIRECTMATERIAL_H
...
class KUESASHARED_EXPORT Iro2GlassEquiRectMaterial : public GLTF2Material
{
    Q_OBJECT
    Q_PROPERTY(Kuesa::Iro2GlassEquiRectProperties *materialProperties READ materialProperties WRITE setMaterialProperties NOTIFY materialPropertiesChanged)

public:
    Q_INVOKABLE explicit Iro2GlassEquiRectMaterial(Qt3DCore::QNode *parent = nullptr);
...
private:
    Iro2GlassEquiRectProperties *m_materialProperties = nullptr;
...
#endif // KUESA_IRO2GLASSEQUIRECTMATERIAL_H
