...
/*
    iro2glassequirectshaderdata_p.h
...
#ifndef KUESA_IRO2GLASSEQUIRECTSHADERDATA_P_H
#define KUESA_IRO2GLASSEQUIRECTSHADERDATA_P_H
...
class Iro2GlassEquiRectShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit Iro2GlassEquiRectShaderData(Qt3DCore::QNode *parent = nullptr);
    ~Iro2GlassEquiRectShaderData();
...
#endif // KUESA_IRO2GLASSEQUIRECTSHADERDATA_P_H
