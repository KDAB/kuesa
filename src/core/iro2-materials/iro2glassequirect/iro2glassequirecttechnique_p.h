/*
    iro2glassequirecttechnique_p.h
...
#ifndef KUESA_IRO2GLASSEQUIRECTTECHNIQUE_P_H
#define KUESA_IRO2GLASSEQUIRECTTECHNIQUE_P_H
...
#endif // KUESA_IRO2GLASSEQUIRECTTECHNIQUE_P_H
