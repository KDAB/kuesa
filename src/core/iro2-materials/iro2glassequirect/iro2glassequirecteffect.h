...
#ifndef KUESA_IRO2GLASSEQUIRECTEFFECT_H
#define KUESA_IRO2GLASSEQUIRECTEFFECT_H
...
class Iro2GlassEquiRectTechnique;

class KUESASHARED_EXPORT Iro2GlassEquiRectEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2GlassEquiRectEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2GlassEquiRectEffect();

private:
    Iro2GlassEquiRectTechnique *m_gl3Technique;
    Iro2GlassEquiRectTechnique *m_es3Technique;
    Iro2GlassEquiRectTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2GlassEquiRectTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2GLASSEQUIRECTEFFECT_H
