/*
    iro2planarreflectionequirecteffect.h
...
#ifndef KUESA_IRO2PLANARREFLECTIONEQUIRECTEFFECT_H
#define KUESA_IRO2PLANARREFLECTIONEQUIRECTEFFECT_H
...
namespace Kuesa {
class Iro2PlanarReflectionEquiRectTechnique;

class KUESASHARED_EXPORT Iro2PlanarReflectionEquiRectEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2PlanarReflectionEquiRectEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2PlanarReflectionEquiRectEffect();

private:
    Iro2PlanarReflectionEquiRectTechnique *m_gl3Technique;
    Iro2PlanarReflectionEquiRectTechnique *m_es3Technique;
    Iro2PlanarReflectionEquiRectTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2PlanarReflectionEquiRectTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2PLANARREFLECTIONEQUIRECTEFFECT_H
