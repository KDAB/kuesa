/*
    iro2planarreflectionequirecttechnique_p.h
...
#ifndef KUESA_IRO2PLANARREFLECTIONEQUIRECTTECHNIQUE_P_H
#define KUESA_IRO2PLANARREFLECTIONEQUIRECTTECHNIQUE_P_H
...
#endif // KUESA_IRO2PLANARREFLECTIONEQUIRECTTECHNIQUE_P_H
