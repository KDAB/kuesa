...
/*
    iro2planarreflectionequirecteffect.cpp
...
#include "iro2planarreflectionequirecteffect.h"
...
class Iro2PlanarReflectionEquiRectTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit Iro2PlanarReflectionEquiRectTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new QFilterKey(this))
    {
        ...
        const QUrl fragmentShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionequirect.frag.json"))
        };
...
/*!
    \class Kuesa::Iro2PlanarReflectionEquiRectEffect
    \inheaderfile Kuesa/Iro2PlanarReflectionEquiRectEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.3

    \brief Kuesa::Iro2PlanarReflectionEquiRectEffect is the effect for the Iro2PlanarReflectionEquiRectMaterial class.
*/

/*!
    \qmltype Iro2PlanarReflectionEquiRectEffect
    \instantiates Kuesa::Iro2PlanarReflectionEquiRectEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.3
...
Iro2PlanarReflectionEquiRectEffect::Iro2PlanarReflectionEquiRectEffect(Qt3DCore::QNode *parent)
    : GLTF2MaterialEffect(parent)
{
    m_gl3Technique = new Iro2PlanarReflectionEquiRectTechnique(Iro2PlanarReflectionEquiRectTechnique::GL3, this);
    m_es3Technique = new Iro2PlanarReflectionEquiRectTechnique(Iro2PlanarReflectionEquiRectTechnique::ES3, this);
    m_es2Technique = new Iro2PlanarReflectionEquiRectTechnique(Iro2PlanarReflectionEquiRectTechnique::ES2, this);
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new Iro2PlanarReflectionEquiRectTechnique(Iro2PlanarReflectionEquiRectTechnique::RHI, this);
    addTechnique(m_rhiTechnique);
#endif
}

Iro2PlanarReflectionEquiRectEffect::~Iro2PlanarReflectionEquiRectEffect() = default;


void Iro2PlanarReflectionEquiRectEffect::updateDoubleSided(bool doubleSided)
{
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingSkinning(bool useSkinning)
{
...
void Iro2PlanarReflectionEquiRectEffect::updateOpaque(bool opaque)
{
...
void Iro2PlanarReflectionEquiRectEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionEquiRectEffect::updateLayersOnTechniques(const QStringList &layers)
{
