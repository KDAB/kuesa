/*
    iro2diffuseequirecttechnique_p.h
...
#ifndef KUESA_IRO2DIFFUSEEQUIRECTTECHNIQUE_P_H
#define KUESA_IRO2DIFFUSEEQUIRECTTECHNIQUE_P_H
...
namespace Kuesa {
class Iro2DiffuseEquiRectTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit Iro2DiffuseEquiRectTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new Qt3DRender::QFilterKey(this))
    {
        ...
        const QUrl fragmentShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffuseequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffuseequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffuseequirect.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffuseequirect.frag.json"))
        };
...
#endif // KUESA_IRO2DIFFUSEEQUIRECTTECHNIQUE_P_H
