...
/*
    iro2diffuseequirectshaderdata.cpp
...
Iro2DiffuseEquiRectShaderData::Iro2DiffuseEquiRectShaderData(Qt3DCore::QNode *parent)
...
bool Iro2DiffuseEquiRectShaderData::usesDiffuseMap() const
{
    return m_usesDiffuseMap;
}

float Iro2DiffuseEquiRectShaderData::diffuseGain() const
{
    return m_diffuseGain;
}

QVector3D Iro2DiffuseEquiRectShaderData::diffuseInnerFilter() const
{
    return m_diffuseInnerFilter;
}

QVector3D Iro2DiffuseEquiRectShaderData::diffuseOuterFilter() const
{
    return m_diffuseOuterFilter;
}

bool Iro2DiffuseEquiRectShaderData::usesReflectionMap() const
{
    return m_usesReflectionMap;
}

float Iro2DiffuseEquiRectShaderData::reflectionGain() const
{
    return m_reflectionGain;
}

QVector3D Iro2DiffuseEquiRectShaderData::reflectionInnerFilter() const
{
    return m_reflectionInnerFilter;
}

QVector3D Iro2DiffuseEquiRectShaderData::reflectionOuterFilter() const
{
    return m_reflectionOuterFilter;
}

bool Iro2DiffuseEquiRectShaderData::usesNormalMap() const
{
    return m_usesNormalMap;
}

float Iro2DiffuseEquiRectShaderData::normalMapGain() const
{
    return m_normalMapGain;
}

QVector3D Iro2DiffuseEquiRectShaderData::normalScaling() const
{
    return m_normalScaling;
}

QVector2D Iro2DiffuseEquiRectShaderData::normalDisturb() const
{
    return m_normalDisturb;
}

float Iro2DiffuseEquiRectShaderData::postVertexColor() const
{
    return m_postVertexColor;
}

QVector3D Iro2DiffuseEquiRectShaderData::postHemiFilter() const
{
    return m_postHemiFilter;
}

float Iro2DiffuseEquiRectShaderData::postGain() const
{
    return m_postGain;
}

bool Iro2DiffuseEquiRectShaderData::gltfYUp() const
{
    return m_gltfYUp;
}
...
void Iro2DiffuseEquiRectShaderData::setDiffuseGain(float diffuseGain)
{
...
void Iro2DiffuseEquiRectShaderData::setDiffuseInnerFilter(const QVector3D &diffuseInnerFilter)
{
...
void Iro2DiffuseEquiRectShaderData::setDiffuseOuterFilter(const QVector3D &diffuseOuterFilter)
{
...
void Iro2DiffuseEquiRectShaderData::setUsesReflectionMap(bool usesReflectionMap)
{
...
void Iro2DiffuseEquiRectShaderData::setReflectionGain(float reflectionGain)
{
...
void Iro2DiffuseEquiRectShaderData::setReflectionInnerFilter(const QVector3D &reflectionInnerFilter)
{
...
void Iro2DiffuseEquiRectShaderData::setReflectionOuterFilter(const QVector3D &reflectionOuterFilter)
{
...
void Iro2DiffuseEquiRectShaderData::setUsesNormalMap(bool usesNormalMap)
{
...
void Iro2DiffuseEquiRectShaderData::setNormalMapGain(float normalMapGain)
{
...
void Iro2DiffuseEquiRectShaderData::setNormalScaling(const QVector3D &normalScaling)
{
...
void Iro2DiffuseEquiRectShaderData::setNormalDisturb(const QVector2D &normalDisturb)
{
...
void Iro2DiffuseEquiRectShaderData::setPostVertexColor(float postVertexColor)
{
...
void Iro2DiffuseEquiRectShaderData::setPostHemiFilter(const QVector3D &postHemiFilter)
{
...
void Iro2DiffuseEquiRectShaderData::setPostGain(float postGain)
{
...
void Iro2DiffuseEquiRectShaderData::setGltfYUp(bool gltfYUp)
{
