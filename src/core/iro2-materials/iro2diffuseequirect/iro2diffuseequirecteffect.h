...
#ifndef KUESA_IRO2DIFFUSEEQUIRECTEFFECT_H
#define KUESA_IRO2DIFFUSEEQUIRECTEFFECT_H
...
class Iro2DiffuseEquiRectTechnique;

class KUESASHARED_EXPORT Iro2DiffuseEquiRectEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2DiffuseEquiRectEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2DiffuseEquiRectEffect();

private:
    Iro2DiffuseEquiRectTechnique *m_gl3Technique;
    Iro2DiffuseEquiRectTechnique *m_es3Technique;
    Iro2DiffuseEquiRectTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2DiffuseEquiRectTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2DIFFUSEEQUIRECTEFFECT_H
