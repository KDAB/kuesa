...
#ifndef KUESA_IRO2ALPHASEMEFFECT_H
#define KUESA_IRO2ALPHASEMEFFECT_H
...
class Iro2AlphaSemTechnique;

class KUESASHARED_EXPORT Iro2AlphaSemEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2AlphaSemEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2AlphaSemEffect();

private:
    Iro2AlphaSemTechnique *m_gl3Technique;
    Iro2AlphaSemTechnique *m_es3Technique;
    Iro2AlphaSemTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2AlphaSemTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2ALPHASEMEFFECT_H
