...
#ifndef KUESA_IRO2ALPHASEMSHADERDATA_P_H
#define KUESA_IRO2ALPHASEMSHADERDATA_P_H
...
class Iro2AlphaSemShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit Iro2AlphaSemShaderData(Qt3DCore::QNode *parent = nullptr);
    ~Iro2AlphaSemShaderData();
...
#endif // KUESA_IRO2ALPHASEMSHADERDATA_P_H
