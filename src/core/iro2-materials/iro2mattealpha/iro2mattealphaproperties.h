...
#ifndef KUESA_IRO2MATTEALPHAPROPERTIES_H
#define KUESA_IRO2MATTEALPHAPROPERTIES_H
...
namespace Kuesa {
class Iro2MatteAlphaShaderData;

class KUESASHARED_EXPORT Iro2MatteAlphaProperties : public GLTF2MaterialProperties
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit Iro2MatteAlphaProperties(Qt3DCore::QNode *parent = nullptr);
