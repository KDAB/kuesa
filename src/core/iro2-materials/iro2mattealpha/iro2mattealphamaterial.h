...
#ifndef KUESA_IRO2MATTEALPHAMATERIAL_H
#define KUESA_IRO2MATTEALPHAMATERIAL_H
...
class KUESASHARED_EXPORT Iro2MatteAlphaMaterial : public GLTF2Material
{
    Q_OBJECT
    Q_PROPERTY(Kuesa::Iro2MatteAlphaProperties *materialProperties READ materialProperties WRITE setMaterialProperties NOTIFY materialPropertiesChanged)

public:
    Q_INVOKABLE explicit Iro2MatteAlphaMaterial(Qt3DCore::QNode *parent = nullptr);
    ~Iro2MatteAlphaMaterial();

    Iro2MatteAlphaProperties *materialProperties() const;
...
private:
    Iro2MatteAlphaProperties *m_materialProperties = nullptr;
...
#endif // KUESA_IRO2MATTEALPHAMATERIAL_H
