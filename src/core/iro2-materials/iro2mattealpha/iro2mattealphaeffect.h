...
#ifndef KUESA_IRO2MATTEALPHAEFFECT_H
#define KUESA_IRO2MATTEALPHAEFFECT_H
...
class Iro2MatteAlphaTechnique;

class KUESASHARED_EXPORT Iro2MatteAlphaEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2MatteAlphaEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2MatteAlphaEffect();

private:
    Iro2MatteAlphaTechnique *m_gl3Technique;
    Iro2MatteAlphaTechnique *m_es3Technique;
    Iro2MatteAlphaTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2MatteAlphaTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2MATTEALPHAEFFECT_H
