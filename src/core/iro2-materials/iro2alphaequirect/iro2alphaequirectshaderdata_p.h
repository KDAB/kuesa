...
/*
    iro2alphaequirectshaderdata_p.h
...
#ifndef KUESA_IRO2ALPHAEQUIRECTSHADERDATA_P_H
#define KUESA_IRO2ALPHAEQUIRECTSHADERDATA_P_H
...
class Iro2AlphaEquiRectShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit Iro2AlphaEquiRectShaderData(Qt3DCore::QNode *parent = nullptr);
    ~Iro2AlphaEquiRectShaderData();
...
#endif // KUESA_IRO2ALPHAEQUIRECTSHADERDATA_P_H
