...
#include "iro2alphaequirecteffect.h"

#include <Qt3DRender/QCullFace>

#include "iro2alphaequirecttechnique_p.h"
...
/*!
    \class Kuesa::Iro2AlphaEquiRectEffect
    \inheaderfile Kuesa/Iro2AlphaEquiRectEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.3

    \brief Kuesa::Iro2AlphaEquiRectEffect is the effect for the Iro2AlphaEquiRectMaterial class.
*/

/*!
    \qmltype Iro2AlphaEquiRectEffect
    \instantiates Kuesa::Iro2AlphaEquiRectEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.3
...
Iro2AlphaEquiRectEffect::Iro2AlphaEquiRectEffect(Qt3DCore::QNode *parent)
    : GLTF2MaterialEffect(parent)
{
    m_gl3Technique = new Iro2AlphaEquiRectTechnique(Iro2AlphaEquiRectTechnique::GL3, this);
    m_es3Technique = new Iro2AlphaEquiRectTechnique(Iro2AlphaEquiRectTechnique::ES3, this);
    m_es2Technique = new Iro2AlphaEquiRectTechnique(Iro2AlphaEquiRectTechnique::ES2, this);
    ...
    m_rhiTechnique = new Iro2AlphaEquiRectTechnique(Iro2AlphaEquiRectTechnique::RHI, this);
    addTechnique(m_rhiTechnique);
#endif
}

Iro2AlphaEquiRectEffect::~Iro2AlphaEquiRectEffect() = default;

void Iro2AlphaEquiRectEffect::updateDoubleSided(bool doubleSided)
{
...
void Iro2AlphaEquiRectEffect::updateUsingSkinning(bool useSkinning)
{
...
void Iro2AlphaEquiRectEffect::updateOpaque(bool opaque)
{
...
void Iro2AlphaEquiRectEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void Iro2AlphaEquiRectEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2AlphaEquiRectEffect::updateLayersOnTechniques(const QStringList &layers)
{
