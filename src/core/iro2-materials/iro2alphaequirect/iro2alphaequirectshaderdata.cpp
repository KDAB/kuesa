...
bool Iro2AlphaEquiRectShaderData::usesReflectionMap() const
{
    return m_usesReflectionMap;
}

float Iro2AlphaEquiRectShaderData::reflectionGain() const
{
    return m_reflectionGain;
}

QVector3D Iro2AlphaEquiRectShaderData::reflectionInnerFilter() const
{
    return m_reflectionInnerFilter;
}

QVector3D Iro2AlphaEquiRectShaderData::reflectionOuterFilter() const
{
    return m_reflectionOuterFilter;
}

float Iro2AlphaEquiRectShaderData::innerAlpha() const
{
    return m_innerAlpha;
}

float Iro2AlphaEquiRectShaderData::outerAlpha() const
{
    return m_outerAlpha;
}

float Iro2AlphaEquiRectShaderData::alphaGain() const
{
    return m_alphaGain;
}

bool Iro2AlphaEquiRectShaderData::usesNormalMap() const
{
    return m_usesNormalMap;
}

float Iro2AlphaEquiRectShaderData::normalMapGain() const
{
    return m_normalMapGain;
}

QVector3D Iro2AlphaEquiRectShaderData::normalScaling() const
{
    return m_normalScaling;
}

QVector2D Iro2AlphaEquiRectShaderData::normalDisturb() const
{
    return m_normalDisturb;
}

float Iro2AlphaEquiRectShaderData::postVertexColor() const
{
    return m_postVertexColor;
}

QVector3D Iro2AlphaEquiRectShaderData::postHemiFilter() const
{
    return m_postHemiFilter;
}

float Iro2AlphaEquiRectShaderData::postGain() const
{
    return m_postGain;
}

bool Iro2AlphaEquiRectShaderData::gltfYUp() const
{
    return m_gltfYUp;
}
...
void Iro2AlphaEquiRectShaderData::setReflectionGain(float reflectionGain)
{
...
void Iro2AlphaEquiRectShaderData::setReflectionInnerFilter(const QVector3D &reflectionInnerFilter)
{
...
void Iro2AlphaEquiRectShaderData::setReflectionOuterFilter(const QVector3D &reflectionOuterFilter)
{
...
void Iro2AlphaEquiRectShaderData::setInnerAlpha(float innerAlpha)
{
...
void Iro2AlphaEquiRectShaderData::setOuterAlpha(float outerAlpha)
{
...
void Iro2AlphaEquiRectShaderData::setAlphaGain(float alphaGain)
{
...
void Iro2AlphaEquiRectShaderData::setUsesNormalMap(bool usesNormalMap)
{
...
void Iro2AlphaEquiRectShaderData::setNormalMapGain(float normalMapGain)
{
...
void Iro2AlphaEquiRectShaderData::setNormalScaling(const QVector3D &normalScaling)
{
...
void Iro2AlphaEquiRectShaderData::setNormalDisturb(const QVector2D &normalDisturb)
{
...
void Iro2AlphaEquiRectShaderData::setPostVertexColor(float postVertexColor)
{
...
void Iro2AlphaEquiRectShaderData::setPostHemiFilter(const QVector3D &postHemiFilter)
{
...
void Iro2AlphaEquiRectShaderData::setPostGain(float postGain)
{
...
void Iro2AlphaEquiRectShaderData::setGltfYUp(bool gltfYUp)
{
