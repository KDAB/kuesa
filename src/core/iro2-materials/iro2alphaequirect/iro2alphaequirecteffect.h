...
#ifndef KUESA_IRO2ALPHAEQUIRECTEFFECT_H
#define KUESA_IRO2ALPHAEQUIRECTEFFECT_H
...
class Iro2AlphaEquiRectTechnique;

class KUESASHARED_EXPORT Iro2AlphaEquiRectEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2AlphaEquiRectEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2AlphaEquiRectEffect();

private:
    Iro2AlphaEquiRectTechnique *m_gl3Technique;
    Iro2AlphaEquiRectTechnique *m_es3Technique;
    Iro2AlphaEquiRectTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2AlphaEquiRectTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2ALPHAEQUIRECTEFFECT_H
