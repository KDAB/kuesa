...
#ifndef KUESA_IRO2GLASSSEMEFFECT_H
#define KUESA_IRO2GLASSSEMEFFECT_H
...
namespace Kuesa {
class Iro2GlassSemTechnique;

class KUESASHARED_EXPORT Iro2GlassSemEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2GlassSemEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2GlassSemEffect();

private:
    Iro2GlassSemTechnique *m_gl3Technique;
    Iro2GlassSemTechnique *m_es3Technique;
    Iro2GlassSemTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2GlassSemTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2GLASSSEMEFFECT_H
