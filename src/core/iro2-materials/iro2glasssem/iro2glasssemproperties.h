...
#ifndef KUESA_IRO2GLASSSEMPROPERTIES_H
#define KUESA_IRO2GLASSSEMPROPERTIES_H
...
public:
    Q_INVOKABLE explicit Iro2GlassSemProperties(Qt3DCore::QNode *parent = nullptr);
    ~Iro2GlassSemProperties();
