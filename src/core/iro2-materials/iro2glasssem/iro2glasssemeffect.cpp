...
/*!
    \qmltype Iro2GlassSemEffect
    \instantiates Kuesa::Iro2GlassSemEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.3
...
{
    m_gl3Technique = new Iro2GlassSemTechnique(Iro2GlassSemTechnique::GL3, this);
    m_es3Technique = new Iro2GlassSemTechnique(Iro2GlassSemTechnique::ES3, this);
    m_es2Technique = new Iro2GlassSemTechnique(Iro2GlassSemTechnique::ES2, this);
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new Iro2GlassSemTechnique(Iro2GlassSemTechnique::RHI, this);
...
void Iro2GlassSemEffect::updateUsingSkinning(bool useSkinning)
{
...
void Iro2GlassSemEffect::updateOpaque(bool opaque)
{
...
void Iro2GlassSemEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void Iro2GlassSemEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2GlassSemEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2GlassSemEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2GlassSemEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2GlassSemEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2GlassSemEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
