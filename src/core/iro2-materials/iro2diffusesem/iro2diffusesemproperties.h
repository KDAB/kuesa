...
#ifndef KUESA_IRO2DIFFUSESEMPROPERTIES_H
#define KUESA_IRO2DIFFUSESEMPROPERTIES_H
...
class Iro2DiffuseSemShaderData;

class KUESASHARED_EXPORT Iro2DiffuseSemProperties : public GLTF2MaterialProperties
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit Iro2DiffuseSemProperties(Qt3DCore::QNode *parent = nullptr);
