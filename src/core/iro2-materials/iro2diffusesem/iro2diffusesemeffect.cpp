...
#include "iro2diffusesemeffect.h"
...
class Iro2DiffuseSemTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit Iro2DiffuseSemTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new QFilterKey(this))
    {
        ...
        const QUrl fragmentShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffusesem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffusesem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffusesem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2diffusesem.frag.json"))
        };
...
/*!
    \qmltype Iro2DiffuseSemEffect
    \instantiates Kuesa::Iro2DiffuseSemEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.3
...
{
    m_gl3Technique = new Iro2DiffuseSemTechnique(Iro2DiffuseSemTechnique::GL3, this);
    m_es3Technique = new Iro2DiffuseSemTechnique(Iro2DiffuseSemTechnique::ES3, this);
    m_es2Technique = new Iro2DiffuseSemTechnique(Iro2DiffuseSemTechnique::ES2, this);
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new Iro2DiffuseSemTechnique(Iro2DiffuseSemTechnique::RHI, this);
...
void Iro2DiffuseSemEffect::updateUsingSkinning(bool useSkinning)
{
...
void Iro2DiffuseSemEffect::updateOpaque(bool opaque)
{
...
void Iro2DiffuseSemEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void Iro2DiffuseSemEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2DiffuseSemEffect::updateLayersOnTechniques(const QStringList &layers)
{
