...
#ifndef KUESA_IRO2DIFFUSESEMSHADERDATA_P_H
#define KUESA_IRO2DIFFUSESEMSHADERDATA_P_H
...
class Iro2DiffuseSemShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit Iro2DiffuseSemShaderData(Qt3DCore::QNode *parent = nullptr);
    ~Iro2DiffuseSemShaderData();
...
#endif // KUESA_IRO2DIFFUSESEMSHADERDATA_P_H
