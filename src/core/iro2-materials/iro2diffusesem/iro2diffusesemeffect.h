...
#ifndef KUESA_IRO2DIFFUSESEMEFFECT_H
#define KUESA_IRO2DIFFUSESEMEFFECT_H
...
class Iro2DiffuseSemTechnique;

class KUESASHARED_EXPORT Iro2DiffuseSemEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2DiffuseSemEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2DiffuseSemEffect();

private:
    Iro2DiffuseSemTechnique *m_gl3Technique;
    Iro2DiffuseSemTechnique *m_es3Technique;
    Iro2DiffuseSemTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2DiffuseSemTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2DIFFUSESEMEFFECT_H
