...
/*
    iro2planarreflectionsemshaderdata_p.h
...
#ifndef KUESA_IRO2PLANARREFLECTIONSEMSHADERDATA_P_H
#define KUESA_IRO2PLANARREFLECTIONSEMSHADERDATA_P_H
...
#endif // KUESA_IRO2PLANARREFLECTIONSEMSHADERDATA_P_H
