/*
    iro2planarreflectionsemtechnique_p.h
...
#ifndef KUESA_IRO2PLANARREFLECTIONSEMTECHNIQUE_P_H
#define KUESA_IRO2PLANARREFLECTIONSEMTECHNIQUE_P_H
...
#endif // KUESA_IRO2PLANARREFLECTIONSEMTECHNIQUE_P_H
