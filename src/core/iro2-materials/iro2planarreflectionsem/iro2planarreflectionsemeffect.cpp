...
/*
    iro2planarreflectionsemeffect.cpp
...
#include "iro2planarreflectionsemeffect.h"
...
class Iro2PlanarReflectionSemTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit Iro2PlanarReflectionSemTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new QFilterKey(this))
    {
        ...
        const QUrl fragmentShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionsem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionsem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionsem.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iro2planarreflectionsem.frag.json"))
        };
...
/*!
    \class Kuesa::Iro2PlanarReflectionSemEffect
    \inheaderfile Kuesa/Iro2PlanarReflectionSemEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.3

    \brief Kuesa::Iro2PlanarReflectionSemEffect is the effect for the Iro2PlanarReflectionSemMaterial class.
*/

/*!
    \qmltype Iro2PlanarReflectionSemEffect
    \instantiates Kuesa::Iro2PlanarReflectionSemEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.3
...
Iro2PlanarReflectionSemEffect::Iro2PlanarReflectionSemEffect(Qt3DCore::QNode *parent)
    : GLTF2MaterialEffect(parent)
{
    m_gl3Technique = new Iro2PlanarReflectionSemTechnique(Iro2PlanarReflectionSemTechnique::GL3, this);
    m_es3Technique = new Iro2PlanarReflectionSemTechnique(Iro2PlanarReflectionSemTechnique::ES3, this);
    m_es2Technique = new Iro2PlanarReflectionSemTechnique(Iro2PlanarReflectionSemTechnique::ES2, this);
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new Iro2PlanarReflectionSemTechnique(Iro2PlanarReflectionSemTechnique::RHI, this);
    addTechnique(m_rhiTechnique);
#endif
}

Iro2PlanarReflectionSemEffect::~Iro2PlanarReflectionSemEffect() = default;


void Iro2PlanarReflectionSemEffect::updateDoubleSided(bool doubleSided)
{
...
void Iro2PlanarReflectionSemEffect::updateUsingSkinning(bool useSkinning)
{
...
void Iro2PlanarReflectionSemEffect::updateOpaque(bool opaque)
{
...
void Iro2PlanarReflectionSemEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void Iro2PlanarReflectionSemEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void Iro2PlanarReflectionSemEffect::updateLayersOnTechniques(const QStringList &layers)
{
