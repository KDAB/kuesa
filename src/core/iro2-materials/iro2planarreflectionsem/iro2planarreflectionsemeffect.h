...
/*
    iro2planarreflectionsemeffect.h
...
#ifndef KUESA_IRO2PLANARREFLECTIONSEMEFFECT_H
#define KUESA_IRO2PLANARREFLECTIONSEMEFFECT_H
...
class Iro2PlanarReflectionSemTechnique;

class KUESASHARED_EXPORT Iro2PlanarReflectionSemEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit Iro2PlanarReflectionSemEffect(Qt3DCore::QNode *parent = nullptr);
    ~Iro2PlanarReflectionSemEffect();

private:
    Iro2PlanarReflectionSemTechnique *m_gl3Technique;
    Iro2PlanarReflectionSemTechnique *m_es3Technique;
    Iro2PlanarReflectionSemTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    Iro2PlanarReflectionSemTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IRO2PLANARREFLECTIONSEMEFFECT_H
