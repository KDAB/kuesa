...
/*!
    ...
    QCamera::setFieldOfView in the importer
 */
...
float FOVAdaptor::degrees() const
{
    return qRadiansToDegrees(m_radians);
}
...
{
    if (radians == m_radians)
        return;
    m_radians = radians;
    Q_EMIT radiansChanged(m_radians);
