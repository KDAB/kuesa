...
#ifndef KUESA_IROMATTESKYBOXSHADERDATA_P_H
#define KUESA_IROMATTESKYBOXSHADERDATA_P_H
...
class IroMatteSkyboxShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
#endif // KUESA_IROMATTESKYBOXSHADERDATA_P_H
