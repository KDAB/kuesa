    ...
    : GLTF2MaterialEffect(parent)
{
    ...
    QObject::connect(this, &GLTF2MaterialEffect::alphaCutoffEnabledChanged, this, &IroMatteSkyboxEffect::updateAlphaCutoffEnabled);
    QObject::connect(this, &GLTF2MaterialEffect::opaqueChanged, this, &IroMatteSkyboxEffect::updateOpaque);
    QObject::connect(this, &GLTF2MaterialEffect::doubleSidedChanged, this, &IroMatteSkyboxEffect::updateDoubleSided);
    QObject::connect(this, &GLTF2MaterialEffect::useSkinningChanged, this, &IroMatteSkyboxEffect::updateSkinning);
