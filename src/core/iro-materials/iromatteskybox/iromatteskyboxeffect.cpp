...
bool IroMatteSkyboxEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool IroMatteSkyboxEffect::useSkinning() const
{
    return m_useSkinning;
}

bool IroMatteSkyboxEffect::isOpaque() const
{
    return m_opaque;
}

bool IroMatteSkyboxEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void IroMatteSkyboxEffect::setDoubleSided(bool doubleSided)
{
...
void IroMatteSkyboxEffect::setUseSkinning(bool useSkinning)
{
...
void IroMatteSkyboxEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void IroMatteSkyboxEffect::setAlphaCutoffEnabled(bool enabled)
{
