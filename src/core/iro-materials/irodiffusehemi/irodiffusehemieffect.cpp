...
public:
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new QFilterKey(this))
    {
        ...
        const QUrl vertexShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/irodiffusehemi.vert.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/irodiffusehemi.vert.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/irodiffusehemi.vert.json"))
        };
...
bool IroDiffuseHemiEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool IroDiffuseHemiEffect::useSkinning() const
{
    return m_useSkinning;
}

bool IroDiffuseHemiEffect::isOpaque() const
{
    return m_opaque;
}

bool IroDiffuseHemiEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void IroDiffuseHemiEffect::setDoubleSided(bool doubleSided)
{
...
void IroDiffuseHemiEffect::setUseSkinning(bool useSkinning)
{
...
void IroDiffuseHemiEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void IroDiffuseHemiEffect::setAlphaCutoffEnabled(bool enabled)
{
