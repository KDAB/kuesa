...
class IroMatteMultShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit IroMatteMultShaderData(Qt3DCore::QNode *parent = nullptr);
    ~IroMatteMultShaderData();
...
#endif // KUESA_IROMATTEMULTSHADERDATA_P_H
