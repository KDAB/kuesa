...
#ifndef KUESA_IROMATTEMULTPROPERTIES_H
#define KUESA_IROMATTEMULTPROPERTIES_H
...
public:
    Q_INVOKABLE explicit IroMatteMultProperties(Qt3DCore::QNode *parent = nullptr);
...
QT_END_NAMESPACE
Q_DECLARE_METATYPE(Kuesa::IroMatteMultProperties*)
#endif // KUESA_IROMATTEMULTPROPERTIES_H
