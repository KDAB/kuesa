...
#include "iromattealphatechnique_p.h"
    ...
    : GLTF2MaterialEffect(parent)
{
    ...
    m_rhiTechnique = new IroMatteAlphaTechnique(IroMatteAlphaTechnique::RHI, this);
...
void IroMatteAlphaEffect::updateDoubleSided(bool doubleSided)
{
...
void IroMatteAlphaEffect::updateUsingSkinning(bool useSkinning)
{
...
void IroMatteAlphaEffect::updateOpaque(bool opaque)
{
...
void IroMatteAlphaEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void IroMatteAlphaEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAlphaEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAlphaEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAlphaEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAlphaEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAlphaEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
