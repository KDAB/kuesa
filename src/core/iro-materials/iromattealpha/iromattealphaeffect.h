...
#ifndef KUESA_IROMATTEALPHAEFFECT_H
#define KUESA_IROMATTEALPHAEFFECT_H
...
class IroMatteAlphaTechnique;

class KUESASHARED_EXPORT IroMatteAlphaEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit IroMatteAlphaEffect(Qt3DCore::QNode *parent = nullptr);
    ~IroMatteAlphaEffect();
...
#endif // KUESA_IROMATTEALPHAEFFECT_H
