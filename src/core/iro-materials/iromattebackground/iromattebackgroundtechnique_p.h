/*
    iromattebackgroundtechnique_p.h
...
#ifndef KUESA_IROMATTEBACKGROUNDTECHNIQUE_P_H
#define KUESA_IROMATTEBACKGROUNDTECHNIQUE_P_H
...
#endif // KUESA_IROMATTEBACKGROUNDTECHNIQUE_P_H
