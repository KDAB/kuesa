    ...
    : GLTF2MaterialEffect(parent)
{
    ...
    QObject::connect(this, &GLTF2MaterialEffect::alphaCutoffEnabledChanged, this, &IroMatteAddEffect::updateAlphaCutoffEnabled);
    QObject::connect(this, &GLTF2MaterialEffect::opaqueChanged, this, &IroMatteAddEffect::updateOpaque);
    QObject::connect(this, &GLTF2MaterialEffect::doubleSidedChanged, this, &IroMatteAddEffect::updateDoubleSided);
    QObject::connect(this, &GLTF2MaterialEffect::useSkinningChanged, this, &IroMatteAddEffect::updateSkinning);
