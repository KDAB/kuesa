...
bool IroMatteAddEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool IroMatteAddEffect::useSkinning() const
{
    return m_useSkinning;
}

bool IroMatteAddEffect::isOpaque() const
{
    return m_opaque;
}

bool IroMatteAddEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void IroMatteAddEffect::setDoubleSided(bool doubleSided)
{
...
void IroMatteAddEffect::setUseSkinning(bool useSkinning)
{
...
void IroMatteAddEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void IroMatteAddEffect::setAlphaCutoffEnabled(bool enabled)
{
