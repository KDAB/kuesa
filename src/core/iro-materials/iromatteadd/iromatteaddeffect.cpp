...
class IroMatteAddTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit IroMatteAddTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
        ...
        , m_techniqueAllowFrustumCullingFilterKey(new QFilterKey(this))
    {
        ...
        const QUrl fragmentShaderGraph[] = {
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iromatteadd.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iromatteadd.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iromatteadd.frag.json")),
            QUrl(QStringLiteral("qrc:/kuesa/shaders/graphs/iromatteadd.frag.json"))
        };
        ...
        m_blendArguments->setSourceRgb(Qt3DRender::QBlendEquationArguments::One);
        m_blendArguments->setSourceAlpha(Qt3DRender::QBlendEquationArguments::Zero);
        m_blendArguments->setDestinationRgb(Qt3DRender::QBlendEquationArguments::One);
...
/*!
    \class Kuesa::IroMatteAddEffect
    \inheaderfile Kuesa/IroMatteAddEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.2

    \brief Kuesa::IroMatteAddEffect is the effect for the IroMatteAddMaterial class.
*/

/*!
    \qmltype IroMatteAddEffect
    \instantiates Kuesa::IroMatteAddEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.2
...
IroMatteAddEffect::IroMatteAddEffect(Qt3DCore::QNode *parent)
    : GLTF2MaterialEffect(parent)
{
    m_gl3Technique = new IroMatteAddTechnique(IroMatteAddTechnique::GL3, this);
    m_es3Technique = new IroMatteAddTechnique(IroMatteAddTechnique::ES3, this);
    m_es2Technique = new IroMatteAddTechnique(IroMatteAddTechnique::ES2, this);
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new IroMatteAddTechnique(IroMatteAddTechnique::RHI, this);
    addTechnique(m_rhiTechnique);
#endif
}

IroMatteAddEffect::~IroMatteAddEffect() = default;


void IroMatteAddEffect::updateDoubleSided(bool doubleSided)
{
...
void IroMatteAddEffect::updateUsingSkinning(bool useSkinning)
{
...
void IroMatteAddEffect::updateOpaque(bool opaque)
{
...
void IroMatteAddEffect::updateAlphaCutoffEnabled(bool enabled)
{
    auto layers = m_gl3Technique->enabledLayers();
    if (enabled) {
...
void IroMatteAddEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateUsingTangentAttribute(bool usingTangentAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateUsingMorphTargets(bool usingMorphTargets)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteAddEffect::updateLayersOnTechniques(const QStringList &layers)
{
