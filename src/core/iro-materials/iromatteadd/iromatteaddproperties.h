...
#ifndef KUESA_IROMATTEADDPROPERTIES_H
#define KUESA_IROMATTEADDPROPERTIES_H
...
class IroMatteAddShaderData;

class KUESASHARED_EXPORT IroMatteAddProperties : public GLTF2MaterialProperties
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit IroMatteAddProperties(Qt3DCore::QNode *parent = nullptr);
...
private:
    IroMatteAddShaderData *m_shaderData;
};
} // namespace Kuesa

QT_END_NAMESPACE
Q_DECLARE_METATYPE(Kuesa::IroMatteAddProperties*)
#endif // KUESA_IROMATTEADDPROPERTIES_H
