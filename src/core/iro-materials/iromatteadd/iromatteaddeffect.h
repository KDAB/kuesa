...
#ifndef KUESA_IROMATTEADDEFFECT_H
#define KUESA_IROMATTEADDEFFECT_H
...
class IroMatteAddTechnique;

class KUESASHARED_EXPORT IroMatteAddEffect : public GLTF2MaterialEffect
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit IroMatteAddEffect(Qt3DCore::QNode *parent = nullptr);
    ~IroMatteAddEffect();

private:
    IroMatteAddTechnique *m_gl3Technique;
    IroMatteAddTechnique *m_es3Technique;
    IroMatteAddTechnique *m_es2Technique;
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    IroMatteAddTechnique *m_rhiTechnique;
#endif
...
#endif // KUESA_IROMATTEADDEFFECT_H
