...
#ifndef KUESA_IROMATTEADDSHADERDATA_P_H
#define KUESA_IROMATTEADDSHADERDATA_P_H
...
namespace Kuesa {
class IroMatteAddShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit IroMatteAddShaderData(Qt3DCore::QNode *parent = nullptr);
    ~IroMatteAddShaderData();
...
#endif // KUESA_IROMATTEADDSHADERDATA_P_H
