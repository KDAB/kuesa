...
Qt3DRender::QAbstractTexture * IroMatteAddShaderData::matteMap() const
{
    return m_matteMap;
}
...
bool IroMatteAddShaderData::gltfYUp() const
{
    return m_gltfYUp;
}
...
void IroMatteAddShaderData::setMatteMap(Qt3DRender::QAbstractTexture * matteMap)
{
    ...
    if (m_matteMap != nullptr) {
        ...
        d->registerDestructionHelper(m_matteMap, &IroMatteAddShaderData::setMatteMap, m_matteMap);
    }
...
void IroMatteAddShaderData::setGltfYUp(bool gltfYUp)
{
