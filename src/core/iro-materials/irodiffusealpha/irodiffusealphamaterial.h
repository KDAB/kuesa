...
#ifndef KUESA_IRODIFFUSEALPHAMATERIAL_H
#define KUESA_IRODIFFUSEALPHAMATERIAL_H
...
class KUESASHARED_EXPORT IroDiffuseAlphaMaterial : public GLTF2Material
{
    Q_OBJECT
    Q_PROPERTY(Kuesa::IroDiffuseAlphaProperties *materialProperties READ materialProperties WRITE setMaterialProperties NOTIFY materialPropertiesChanged)

public:
    Q_INVOKABLE explicit IroDiffuseAlphaMaterial(Qt3DCore::QNode *parent = nullptr);
    ~IroDiffuseAlphaMaterial();

    IroDiffuseAlphaProperties *materialProperties() const;
...
#endif // KUESA_IRODIFFUSEALPHAMATERIAL_H
