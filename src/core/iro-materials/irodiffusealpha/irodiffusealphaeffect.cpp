...
#include "irodiffusealphatechnique_p.h"
...
void IroDiffuseAlphaEffect::updateUsingSkinning(bool useSkinning)
{
...
void IroDiffuseAlphaEffect::updateInstanced(bool instanced)
{
    auto layers = m_gl3Technique->enabledLayers();
