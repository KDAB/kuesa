...
bool IroDiffuseAlphaEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool IroDiffuseAlphaEffect::useSkinning() const
{
    return m_useSkinning;
}

bool IroDiffuseAlphaEffect::isOpaque() const
{
    return m_opaque;
}

bool IroDiffuseAlphaEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void IroDiffuseAlphaEffect::setDoubleSided(bool doubleSided)
{
...
void IroDiffuseAlphaEffect::setUseSkinning(bool useSkinning)
{
...
void IroDiffuseAlphaEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void IroDiffuseAlphaEffect::setAlphaCutoffEnabled(bool enabled)
{
