...
class SphericalEnvMapShaderData;

class KUESASHARED_EXPORT SphericalEnvMapProperties : public GLTF2MaterialProperties
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit SphericalEnvMapProperties(Qt3DCore::QNode *parent = nullptr);
    ~SphericalEnvMapProperties();
...
private:
    SphericalEnvMapShaderData *m_shaderData;
};
} // namespace Kuesa

QT_END_NAMESPACE

#endif // KUESA_SPHERICALENVMAPPROPERTIES_H
