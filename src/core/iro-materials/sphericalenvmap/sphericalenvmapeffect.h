...
#ifndef KUESA_SPHERICALENVMAPEFFECT_H
#define KUESA_SPHERICALENVMAPEFFECT_H
...
class SphericalEnvMapTechnique;

class KUESASHARED_EXPORT SphericalEnvMapEffect : public Qt3DRender::QEffect
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit SphericalEnvMapEffect(Qt3DCore::QNode *parent = nullptr);
    ~SphericalEnvMapEffect();
...
private:
    ...
    SphericalEnvMapTechnique *m_gl3Technique;
    SphericalEnvMapTechnique *m_es3Technique;
    SphericalEnvMapTechnique *m_es2Technique;
};
...
#endif // KUESA_SPHERICALENVMAPEFFECT_H
