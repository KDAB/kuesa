...
#include "iromatteopaqueeffect.h"
...
class IroMatteOpaqueTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit IroMatteOpaqueTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
...
/*!
    \class Kuesa::IroMatteOpaqueEffect
    \inheaderfile Kuesa/IroMatteOpaqueEffect
...
/*!
    \qmltype IroMatteOpaqueEffect
    \instantiates Kuesa::IroMatteOpaqueEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.2
...
#if QT_VERSION >= QT_VERSION_CHECK(6, 0, 0)
    m_rhiTechnique = new IroMatteOpaqueTechnique(IroMatteOpaqueTechnique::RHI, this);
...
void IroMatteOpaqueEffect::updateUsingSkinning(bool useSkinning)
{
...
void IroMatteOpaqueEffect::updateUsingColorAttribute(bool usingColorAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteOpaqueEffect::updateUsingNormalAttribute(bool usingNormalAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteOpaqueEffect::updateUsingTexCoordAttribute(bool usingTexCoordAttribute)
{
    auto layers = m_gl3Technique->enabledLayers();
...
void IroMatteOpaqueEffect::updateUsingTexCoord1Attribute(bool usingTexCoord1Attribute)
{
    auto layers = m_gl3Technique->enabledLayers();
