...
#ifndef KUESA_IROMATTEOPAQUEPROPERTIES_H
#define KUESA_IROMATTEOPAQUEPROPERTIES_H
...
public:
    Q_INVOKABLE explicit IroMatteOpaqueProperties(Qt3DCore::QNode *parent = nullptr);
