...
#ifndef KUESA_IROMATTEOPAQUESHADERDATA_P_H
#define KUESA_IROMATTEOPAQUESHADERDATA_P_H
...
class IroMatteOpaqueShaderData : public Qt3DRender::QShaderData
{
    Q_OBJECT
...
public:
    explicit IroMatteOpaqueShaderData(Qt3DCore::QNode *parent = nullptr);
    ~IroMatteOpaqueShaderData();
...
#endif // KUESA_IROMATTEOPAQUESHADERDATA_P_H
