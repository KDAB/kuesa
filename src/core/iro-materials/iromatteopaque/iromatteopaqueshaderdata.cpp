...
Qt3DRender::QAbstractTexture * IroMatteOpaqueShaderData::matteMap() const
{
    return m_matteMap;
}
...
bool IroMatteOpaqueShaderData::gltfYUp() const
{
    return m_gltfYUp;
}
...
void IroMatteOpaqueShaderData::setMatteMap(Qt3DRender::QAbstractTexture * matteMap)
{
    ...
    if (m_matteMap != nullptr) {
        ...
        d->registerDestructionHelper(m_matteMap, &IroMatteOpaqueShaderData::setMatteMap, m_matteMap);
    }
...
void IroMatteOpaqueShaderData::setGltfYUp(bool gltfYUp)
{
