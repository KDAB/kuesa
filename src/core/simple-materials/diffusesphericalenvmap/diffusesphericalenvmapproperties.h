...
/*
    diffusesphericalenvmapproperties.h
...
#ifndef KUESA_DIFFUSESPHERICALENVMAPPROPERTIES_H
#define KUESA_DIFFUSESPHERICALENVMAPPROPERTIES_H
...
class DiffuseSphericalEnvMapShaderData;

class KUESASHARED_EXPORT DiffuseSphericalEnvMapProperties : public GLTF2MaterialProperties
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit DiffuseSphericalEnvMapProperties(Qt3DCore::QNode *parent = nullptr);
    ~DiffuseSphericalEnvMapProperties();
...
private:
    DiffuseSphericalEnvMapShaderData *m_shaderData;
};
} // namespace Kuesa

QT_END_NAMESPACE

#endif // KUESA_DIFFUSESPHERICALENVMAPPROPERTIES_H
