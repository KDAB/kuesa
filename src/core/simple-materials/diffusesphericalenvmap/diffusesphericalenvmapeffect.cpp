...
/*
    diffusesphericalenvmapeffect.cpp
...
#include "diffusesphericalenvmapeffect.h"
...
class DiffuseSphericalEnvMapTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit DiffuseSphericalEnvMapTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
...
/*!
    \class Kuesa::DiffuseSphericalEnvMapEffect
    \inheaderfile Kuesa/DiffuseSphericalEnvMapEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.2

    \brief Kuesa::DiffuseSphericalEnvMapEffect is the effect for the DiffuseSphericalEnvMapMaterial class
*/

/*!
    \qmltype DiffuseSphericalEnvMapEffect
    \instantiates Kuesa::DiffuseSphericalEnvMapEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.2
...
DiffuseSphericalEnvMapEffect::DiffuseSphericalEnvMapEffect(Qt3DCore::QNode *parent)
    : QEffect(parent)
    , m_useSkinning(false)
    , m_opaque(true)
    , m_alphaCutoffEnabled(false)
{
    ...
    m_gl3Technique = new DiffuseSphericalEnvMapTechnique(DiffuseSphericalEnvMapTechnique::GL3, this);
    m_gl3Technique->setEnabledLayers(enabledLayers);

    m_es3Technique = new DiffuseSphericalEnvMapTechnique(DiffuseSphericalEnvMapTechnique::ES3, this);
    m_es3Technique->setEnabledLayers(enabledLayers);

    m_es2Technique = new DiffuseSphericalEnvMapTechnique(DiffuseSphericalEnvMapTechnique::ES2, this);
...
DiffuseSphericalEnvMapEffect::~DiffuseSphericalEnvMapEffect() = default;

bool DiffuseSphericalEnvMapEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool DiffuseSphericalEnvMapEffect::useSkinning() const
{
    return m_useSkinning;
}

bool DiffuseSphericalEnvMapEffect::isOpaque() const
{
    return m_opaque;
}

bool DiffuseSphericalEnvMapEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void DiffuseSphericalEnvMapEffect::setDoubleSided(bool doubleSided)
{
...
void DiffuseSphericalEnvMapEffect::setUseSkinning(bool useSkinning)
{
...
void DiffuseSphericalEnvMapEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void DiffuseSphericalEnvMapEffect::setAlphaCutoffEnabled(bool enabled)
{
