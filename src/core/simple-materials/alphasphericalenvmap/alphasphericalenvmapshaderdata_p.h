...
/*
    alphasphericalenvmapshaderdata_p.h
...
#ifndef KUESA_ALPHASPHERICALENVMAPSHADERDATA_P_H
#define KUESA_ALPHASPHERICALENVMAPSHADERDATA_P_H
...
class AlphaSphericalEnvMapShaderData : public Qt3DRender::QShaderData
{
   Q_OBJECT
...
public:
    explicit AlphaSphericalEnvMapShaderData(Qt3DCore::QNode *parent = nullptr);
    ~AlphaSphericalEnvMapShaderData();
...
#endif // KUESA_ALPHASPHERICALENVMAPSHADERDATA_P_H
