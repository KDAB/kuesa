...
#ifndef KUESA_ALPHASPHERICALENVMAPEFFECT_H
#define KUESA_ALPHASPHERICALENVMAPEFFECT_H
...
class AlphaSphericalEnvMapTechnique;

class KUESASHARED_EXPORT AlphaSphericalEnvMapEffect : public Qt3DRender::QEffect
{
    Q_OBJECT
...
public:
    Q_INVOKABLE explicit AlphaSphericalEnvMapEffect(Qt3DCore::QNode *parent = nullptr);
    ~AlphaSphericalEnvMapEffect();
...
private:
    ...
    AlphaSphericalEnvMapTechnique *m_gl3Technique;
    AlphaSphericalEnvMapTechnique *m_es3Technique;
    AlphaSphericalEnvMapTechnique *m_es2Technique;
};
...
#endif // KUESA_ALPHASPHERICALENVMAPEFFECT_H
