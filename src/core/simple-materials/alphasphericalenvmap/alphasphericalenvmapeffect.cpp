...
/*
    alphasphericalenvmapeffect.cpp
...
#include "alphasphericalenvmapeffect.h"
...
class AlphaSphericalEnvMapTechnique : public Qt3DRender::QTechnique
{
public:
    enum Version {
        GL3 = 0,
    ...
    explicit AlphaSphericalEnvMapTechnique(Version version, Qt3DCore::QNode *parent = nullptr)
        : QTechnique(parent)
...
/*!
    \class Kuesa::AlphaSphericalEnvMapEffect
    \inheaderfile Kuesa/AlphaSphericalEnvMapEffect
    \inherits Qt3DRender::QEffect
    \inmodule Kuesa
    \since Kuesa 1.2

    \brief Kuesa::AlphaSphericalEnvMapEffect is the effect for the AlphaSphericalEnvMapMaterial class
*/

/*!
    \qmltype AlphaSphericalEnvMapEffect
    \instantiates Kuesa::AlphaSphericalEnvMapEffect
    \inqmlmodule Kuesa
    \since Kuesa 1.2
...
AlphaSphericalEnvMapEffect::AlphaSphericalEnvMapEffect(Qt3DCore::QNode *parent)
    : QEffect(parent)
    , m_useSkinning(false)
    , m_opaque(true)
    , m_alphaCutoffEnabled(false)
{
    ...
    m_gl3Technique = new AlphaSphericalEnvMapTechnique(AlphaSphericalEnvMapTechnique::GL3, this);
    m_gl3Technique->setEnabledLayers(enabledLayers);

    m_es3Technique = new AlphaSphericalEnvMapTechnique(AlphaSphericalEnvMapTechnique::ES3, this);
    m_es3Technique->setEnabledLayers(enabledLayers);

    m_es2Technique = new AlphaSphericalEnvMapTechnique(AlphaSphericalEnvMapTechnique::ES2, this);
...
AlphaSphericalEnvMapEffect::~AlphaSphericalEnvMapEffect() = default;

bool AlphaSphericalEnvMapEffect::isDoubleSided() const
{
    return m_gl3Technique->cullingMode() == QCullFace::NoCulling;
}

bool AlphaSphericalEnvMapEffect::useSkinning() const
{
    return m_useSkinning;
}

bool AlphaSphericalEnvMapEffect::isOpaque() const
{
    return m_opaque;
}

bool AlphaSphericalEnvMapEffect::isAlphaCutoffEnabled() const
{
    return m_alphaCutoffEnabled;
}

void AlphaSphericalEnvMapEffect::setDoubleSided(bool doubleSided)
{
...
void AlphaSphericalEnvMapEffect::setUseSkinning(bool useSkinning)
{
...
void AlphaSphericalEnvMapEffect::setOpaque(bool opaque)
{
    if (opaque == m_opaque)
        return;
    m_opaque = opaque;
...
void AlphaSphericalEnvMapEffect::setAlphaCutoffEnabled(bool enabled)
{
