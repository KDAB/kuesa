...
/*!
 * \fn AnimationClipCollection::find
 *
...
AnimationClipCollection::AnimationClipCollection(Qt3DCore::QNode *parent)
    : AbstractAssetCollection(parent)
{
}

/*! \internal */
AnimationClipCollection::~AnimationClipCollection()
{
}

/*!
 * Utility method to create an instance of Qt3DAnimation::QAnimationClipLoader for
...
{
    auto clip = new Qt3DAnimation::QAnimationClipLoader(this);
    clip->setObjectName(name);
