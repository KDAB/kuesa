...
/*!
 * \class Kuesa::TransformCollection
 * \inheaderfile Kuesa/TransformCollection
 * \brief A collection of assets of type Qt3DCore::QTransform.
 * \inmodule Kuesa
 * \since Kuesa 1.2
 * \inherits Kuesa::AbstractAssetCollection
 *
 * Kuesa::TransformCollection manages a set of Qt3DCore::QTransform assets.
 */
...
TransformCollection::TransformCollection(Qt3DCore::QNode *parent)
