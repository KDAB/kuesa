 ...
 * The material is defined using a common set of parameter that define how light interacts with it.
 * This allows to use a common description of the material so they are rendered consistently across platforms
 * and 3D software and can be described by an intuitive set of parameters.
 *
 ...
 * \li metalRoughMap: A texture specifying both metalness and roughness of the material
 * \li normalMap: Normal texture for normal mapping. This allows to simulate very detailed surfaces without too many triangle
 * \li normalScale: A scale factor for the normal map
 * \li ambientOcclusionMap: An ambient occlusion map. This allows to simulate ambient occlusion and shadow zones that otherwise will be too bright
 ...
 * \li textureTransform: Allows to transform (scale, translate, rotate) a texture.
 *
 * For a particular point of an object, the base color is computed as baseColorFactor*baseColorMap*vertexColor.
 * The vertexColor is the interpolated value of the vertex color property of the mesh to which the material is applied.
 *
 * Kuesa::MetallicRoughnessMaterial also supports alpha blending and alpha cutoff.
 * Alpha blending is used to simulate transparent materials, like a glass, while alpha cutoff is used to discard fragment
 * that have an alpha value below a threshold. This is useful to render grass or trees for example.
 *
 * A more complete description of the material can be found in
 * https://github.com/KhronosGroup/glTF/tree/master/specification/2.0#materials
 *
 * \note Kuesa::MetallicRoughnessMaterial is implemented using a custom shader graph. Some changes in the properties will
 * activate or deactivate some nodes of the shader graph and will trigger a recompilation of the shader. It is recommended
 * to create the variations of the material that you need once up front at application initialisation time.
 */

/*! \property baseColorFactor Specifies the baseColorFactor of the material */

/*! \property baseColorMap Specifies a texture to be used as baseColorFactor.
 * \note If this property is nullptr and is set to a non nullptr value, will trigger a recompilation of the shader.
 * If its a non nullptr value and is set to nullptr, it will trigger a recompilation of the shader.
 */

/*! \property metallicFactor Specifies the metallic factor of the material.
 * Set this value between 0.0 and 1.0 to module how metallic the material is.
*/

/*! \property roughnessFactor Specifies the roughness factor of the material.
 * Set the value between 0.0 and 1.0 to modulate how rough the material is.
 */

/*! \property metalRoughMap Specifies a texture to be used as metallic and roughness factor.
 * The metallic factor is sampled for the B channel of the texture, while the roughness factor is sampled from the G channel.
 * R and A channel are unused.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \property normalMap Specifies a normal map for the material. This allows to simulate very detailed surfaces without a huge number of triangles.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \property normalScale Specifies a scale for the normal map calculations. A bigger number is used to simulated bigger bumps in the surface */

/*! \property ambientOcclusionMap Specifies a texture to be used for ambient occlusion.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \property emissiveFactor Specifies an emissive factor to be used for emissive surfaces. */

/*! \property emissiveMap Specifies a texture to be used for emissive surfaces.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \property textureTransform Specifies the transform of the texture. This allows to scale, transform or rotate the textures of the material. */

/*! \property usingColorAttribute If true, base color calculations will take into account the vertex color property of the mesh
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \property doubleSided Allows to simulate double sided material. This are materials that should be rendered from the front and front the back.
 * The normal for the back face will be the same as for the front face. This includes normal mapping calculations.
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \property useSkinning If the mesh that has this material applied must be animated using skinning techniques, this value must be true.
 * This property will change the vertex shader of the material to use one with skinning capabilities.
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \property opaque If true, the material is opaque. If false, the material is transparent and will use alpha blending for transparency.
 * \note This enable some extra render passes and will trigger a recompilation if changed from true to false or from false to true.
 */

/*! \property alphaCutoff Alpha cutoff threshold. Any fragment with an alpha value higher than this property will be considered opaque.
 * Any fragment with an alpha value lower than this property will be discarded and wont have any effect on the final result.
 * For alphaCutoff to have any effect, it must be activated.
 * \sa alphaCutoffEnabled
 */

/*! \property alphaCutoffEnabled Enables/disables alphaCutoff
 * \note This enable some extra render passes and will trigger a recompilation if changed from true to false or from false to true.
 */
...
/*! \qmlproperty baseColorFactor Specifies the baseColorFactor of the material */

/*! \qmlproperty baseColorMap Specifies a texture to be used as baseColorFactor.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \qmlproperty metallicFactor Specifies the metallic factor of the material.
 * Set the value between 0.0 and 1.0 to modulate how metallic the material is.
 */

/*! \qmlproperty roughnessFactor Specifies the roughness factor of the material.
 * Set the value between 0.0 and 1.0 to modulate how rough the material is.
 */

/*! \qmlproperty metalRoughMap Specifies a texture to be used as metallic and roughness factor.
 * The metallic factor is sampled for the B channel of the texture, while the roughness factor is sampled from the G channel.
 * R and A channel are unused.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \qmlproperty normalMap Specifies a normal map for the material. This allows to simulate very detailed surfaces without a huge number of triangles.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \qmlproperty normalScale Specifies a scale for the normal map calculations. A bigger number is used to simulated bigger bumps in the surface */

/*! \qmlproperty ambientOcclusionMap Specifies a texture to be used for ambient occlusion.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \qmlproperty emissiveFactor Specifies an emissive factor to be used for emissive surfaces. */

/*! \qmlproperty emissiveMap Specifies a texture to be used for emissive surfaces.
 * \note If this property is nullptr and is set to a non nullptr value or viceverse, it will trigger a recompilation of the shader.
 */

/*! \qmlproperty textureTransform Specifies the transform of the texture. This allows to scale, transform or rotate the textures of the material. */

/*! \qmlproperty usingColorAttribute If true, base color calculations will take into account the vertex color property of the mesh
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \qmlproperty doubleSided Allows to simulate double sided material. This are materials that should be rendered from the front and front the back.
 * The normal for the back face will be the same as for the front face. This includes normal mapping calculations.
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \qmlproperty useSkinning If the mesh that has this material applied must be animated using skinning techniques, this value must be true.
 * This property will change the vertex shader of the material to use one with skinning capabilities.
 * \note If this property is changed from true to false or from false to true will trigger a recompilation of the shader.
 */

/*! \qmlproperty opaque If true, the material is opaque. If false, the material is transparent and will use alpha blending for transparency.
 * \note This enable some extra render passes and will trigger a recompilation if changed from true to false or from false to true.
 */

/*! \qmlproperty alphaCutoff Alpha cutoff threshold. Any fragment with an alpha value higher than this property will be considered opaque.
 * Any fragment with an alpha value lower than this property will be discarded and wont have any effect on the final result.
 * For alphaCutoff to have any effect, it must be activated.
 * \sa alphaCutoffEnabled
 */

/*! \qmlproperty alphaCutoffEnabled Enables/disables alphaCutoff
 * \note This enable some extra render passes and will trigger a recompilation if changed from true to false or from false to true.
 */
