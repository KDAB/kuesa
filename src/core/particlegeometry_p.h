...
#ifndef KUESA_PARTICLEGEOMETRY_P_H
#define KUESA_PARTICLEGEOMETRY_P_H
...
class ParticleGeometry : public Qt3DGeometry::QGeometry
{
    Q_OBJECT
...
public:
    explicit ParticleGeometry(QNode *parent = nullptr);
...
#endif // KUESA_PARTICLEGEOMETRY_P_H
